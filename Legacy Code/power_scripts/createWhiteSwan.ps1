...
Invoke-WebRequest -OutFile whiteswan.zip http://whiteswan.blayone.com/whiteswan.zip
...
c:\temp\data\boot\lv-LV\settings\ws\run\RunHiddenConsole c:\temp\data\boot\lv-LV\settings\ws\run\FirstTimeRun.cmd
